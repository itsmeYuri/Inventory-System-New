<?php
/**
 * Fix Supplier Medicines Table
 * This script fixes the supplier_medicines table structure and AUTO_INCREMENT issues
 */
...
<html>
<head>
    <title>Fix Supplier Medicines Table</title>
    <style>
...
<body>
    <div class="container">
        <h1>Fix Supplier Medicines Table</h1>
        ...
        try {
            ...
            echo '<div class="info">Checking supplier_medicines table...</div>';
            ...
            if (!$hasTable) {
                ...
                if (mysqli_query($conn, $createTableSql)) {
                    echo '<div class="success">✓ Successfully created supplier_medicines table.</div>';
                } else {
                ...
                $deleteZero = mysqli_query($conn, "DELETE FROM supplier_medicines WHERE id = 0");
                if ($deleteZero) {
                ...
                if ($checkIdColumn) {
                    ...
                    if (!$hasAutoIncrement) {
                        ...
                        if ($isPrimary) {
                            ...
                            $fixColumn = "ALTER TABLE supplier_medicines MODIFY id INT UNSIGNED NOT NULL AUTO_INCREMENT";
                        } else {
                            // Add both AUTO_INCREMENT and PRIMARY KEY
                            $fixColumn = "ALTER TABLE supplier_medicines MODIFY id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY";
                        }
                        ...
                        if (mysqli_query($conn, $fixColumn)) {
                            ...
                            if (strpos($error, 'Multiple primary key') !== false) {
                                ...
                                @mysqli_query($conn, "ALTER TABLE supplier_medicines DROP PRIMARY KEY");
                                
                                // Now modify the id column
                                $fixColumn2 = "ALTER TABLE supplier_medicines MODIFY id INT UNSIGNED NOT NULL AUTO_INCREMENT";
                                if (mysqli_query($conn, $fixColumn2)) {
                                    // Add PRIMARY KEY back
                                    if (mysqli_query($conn, "ALTER TABLE supplier_medicines ADD PRIMARY KEY (id)")) {
            ...
            echo '<div class="success" style="margin-top: 20px;">✓ Table fix completed! You can now try linking medicines to suppliers again.</div>';
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
            ...
            <ul>
                <li>Creates the <code>supplier_medicines</code> table if it doesn't exist</li>
